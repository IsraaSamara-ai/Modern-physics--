...
with tab1:
    ...
    with col_explain:
        ...
        <div class="warning-box">
            <h4>❌ لماذا فشلت الفيزياء الكلاسيكية؟</h4>
            <p>نموذج <b>رايلي-جينز</b> (الخط الأحمر المتقطع) يتفق مع التجربة في منطقة الأطوال الموجية الكبيرة 
            (الأشعة تحت الحمراء)، لكنه يتوقع أن شدة الإشعاع <b>تؤول إلى اللانهاية</b> عند الأطوال الموجية القصيرة 
            (الأشعة فوق البنفسجية)!</p>
            <p>هذا مستحيل فيزيائياً وعُرف بـ<b> "كارثة الأشعة فوق البنفسجية"</b>.</p>
        </div>
        <div class="result-box">
            <h4>✅ حلّ بلانك: تكمية الطاقة</h4>
            <p>افترض بلانك أن الطاقة لا تُشعّ أو تُمتصّ بشكل متّصل، بل على شكل <b>حزم منفصلة</b> تُسمّى <b>كمّات (Quanta)</b>:</p>
        </div>
        <div class="formula-box">E = hf &nbsp;&nbsp;→&nbsp;&nbsp; E<sub>n</sub> = nhf</div>
        <div class="explain-box">
            <p>حيث <b>h = 6.63 × 10<sup>-34</sup> J·s</b> (ثابت بلانك) و <b>f</b> التردد و <b>n</b> عدد صحيح موجب.</p>
            <p>كل كمة طاقة <b>E = hf</b>، والطاقة الكلية عند تردد معيّن تكون <b>nhf</b> (أي hf, 2hf, 3hf, ...) وليست أي قيمة بينها.</p>
        </div>
        """)
